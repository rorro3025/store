...
const handleCancel = () => setConfirmed(false)
    return (
        <Layout>
            <Head>
                <title>Bag</title>
                <script src="https://www.paypal.com/sdk/js?client-id=AdhZgg5imO91CYczWGUQmhNNOva1fCQL1Qk1uLVqqpClsLTzPrM2sA2qiD_wf2uc2uFbb8n7lFA9alhg"></script>
            </Head>
                ...
                <div className="row mt-3">
                    ...
                    <div className="col-md-auto">
                        ...
                        <div className="d-grid gap-2">
                            <button className="btn btn-success" onClick={handleConfirm} disabled={amount === 0}>Confirm order</button>
                            <button className="btn btn-danger" onClick={handleCancel} disabled={confirmed === false}>Cancel</button>
                        </div>
                        {confirmed === true &&
