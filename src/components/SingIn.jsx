...
function SingIn() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        signInWithEmailAndPassword(auth, singInInfo.email, singInInfo.password).then(() => setSession(true))
        ...
        <main className="form-signin">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-floating">
                    <input type="email" name={"email"} className={"form-control"} placeholder={"some@email.com"} onChange={handleChange} />
